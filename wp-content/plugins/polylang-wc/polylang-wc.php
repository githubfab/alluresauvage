...
/**
 * Copyright 2016-2018 Frédéric Demarle
 *
...
define( 'PLLWC_VERSION', '0.9.5' );
define( 'PLLWC_MIN_PLL_VERSION', '1.9.2' );
...
class Polylang_Woocommerce {
	...
	public function __construct() {
		...
		if ( isset( $_GET['action'] ) && 'woocommerce_feature_product' === $_GET['action'] ) {
	...
	public function admin_notices() {
		...
		printf(
			...
			sprintf(
				...
				esc_html__( 'You are using Polylang %1$s. Polylang for WooCommerce requires at least Polylang %2$s.', 'pllwc' ),
				POLYLANG_VERSION,
	...
	public function delete_product_transients( $post_id ) {
		...
		foreach ( pll_get_post_translations( $post_id ) as $tr_id ) {
