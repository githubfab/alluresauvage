...
/**
 * Manages compatibility with WooCommerce Stripe Gateway
...
class PLLWC_Stripe {
	...
	public function __construct() {
		if ( PLL() instanceof PLL_Frontend ) {
			...
			// Unfortunately, Stripe doesn't use the standard get_description() function, bypassing the woocommerce_gateway_description filter
	...
	/**
	 * Workaround bypassed 'woocommerce_gateway_description' filter
	 *
	 * @since 0.9.3
	 *
