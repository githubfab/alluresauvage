...
<tr>
<th scope="row">Highlight Search Term</th>
<td>
	<fieldset><legend class="screen-reader-text"><span>Highlight Search Term</span></legend>
	<label title='Yes'><input type='radio' name='highlight_search_term' value='Yes' <?php if($Highlight_Search_Term == "Yes") {echo "checked='checked'";} ?> /> <span>Yes</span></label><br />
	<label title='No'><input type='radio' name='highlight_search_term' value='No' <?php if($Highlight_Search_Term == "No") {echo "checked='checked'";} ?> /> <span>No</span></label><br />
	<p>Should the term used for the search be highlighted when using the FAQ search shortcode?</p>
	</fieldset>
</td>
</tr>
<tr>
