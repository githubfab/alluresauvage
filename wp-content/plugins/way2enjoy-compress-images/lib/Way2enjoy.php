...
//if($opts['quota_remaining'] >'0')
	//{
// $this->_apiEndPoint = 'http://way2enjoy.com/wordpress/1/2/3/apiwpimgcompressor61.php';

 $this->_apiEndPoint = 'http://way2enjoy.com/modules/compress-png/wpimgoptimizer19.php';
